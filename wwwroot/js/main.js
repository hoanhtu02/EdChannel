    ...
    $(document).ready(() => {
        var axilInit = {
            ...
            methods: function (e) {
                ...
                axilInit.countdownInit('.coming-countdown', '2023/12/01');
                axilInit.campaignCountdown('.campaign-countdown', '2023/12/01');
                axilInit.countdownInit('.poster-countdown', '2023/12/01');
                axilInit.countdownInit('.sale-countdown', '2023/12/01');
