...
{
    /// <inheritdoc />
    public partial class First_Push : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SeassionId = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    TokenId = table.Column<long>(type: "bigint", maxLength: 100, nullable: true),
                    Status = table.Column<int>(type: "int", maxLength: 6, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Promo = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductMeta", x => new { x.Id, x.ProductId });
                    table.ForeignKey(
