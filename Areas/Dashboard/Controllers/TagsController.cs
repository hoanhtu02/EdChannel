...
namespace EdChannel.Areas.Dashboard.Controllers
{
    ...
    public class TagsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,MetaTitle,Slug,Details")] Tag tag)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(long id, [Bind("Id,Title,MetaTitle,Slug,Details")] Tag tag)
        {
            if (id != tag.Id)
            {
                return NotFound();
